    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                  color: Color(0xff45006F).withOpacity(0.35), blurRadius: 14),
            ]),
        child: ListTile(
          leading: Container(
            decoration: BoxDecoration(
          ...
          title:
              Text('Начните зарабатывать!', style: AppTextStyles.black15w700),
          subtitle: Text(
...
class ReklamniyPart extends StatelessWidget {
  const ReklamniyPart({Key? key}) : super(key: key);
